...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L1] = LAYOUT(
	...
	XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      O_L4,         O_L3,         KC_SPC,       KC_ENT,       O_L3,         O_L4,         XXXXXXX,      XXXXXXX,      XXXXXXX,      MS_ACL0
  ),
  ...
  [L4] = LAYOUT(
	...
	_______,      KC_6,         KC_7,         KC_8,         KC_9,         KC_0,                                     KC_HOME,      KC_PGDN,      KC_PGUP,      KC_END,       KC_F12,       KC_RGUI,
