...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L1] = LAYOUT(
	MS_BTN1,      KC_COPY,      KC_PASTE,     KC_EQL,       KC_PLUS,      KC_MINS,                                  MS_LEFT,      MS_DOWN,      MS_UP,        MS_RGHT,      MS_BTN3,      MS_BTN2,
	G_TAB,        KC_Q,         KC_W,         KC_E,         KC_R,         KC_T,                                     KC_Y,         KC_U,         KC_I,         KC_O,         KC_P,         G_EQL,
	KC_BSPC,      KC_A,         KC_S,         KC_D,         KC_F,         KC_G,                                     KC_H,         KC_J,         KC_K,         KC_L,         KC_RCTL,      KC_QUOT,
	O_LSFT,       KC_Z,         KC_X,         KC_C,         KC_V,         KC_B,                                     KC_N,         KC_M,         A_COMM,       KC_DOT,       KC_SLSH,      O_RSFT,
	KC_ESC,       KC_LCTL,      KC_WSCH,      KC_WFAV,      O_L4,         O_L3,         KC_SPC,       KC_ENT,       O_L3,         O_L4,         KC_CALC,      KC_PSCR,      KC_RCTL,      KC_COLN
  ),
  ...
  [L3] = LAYOUT(
	XXXXXXX,      XXXXXXX,      SS_SPC4,      _______,      _______,      _______,                                  XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,
  ...
  [L4] = LAYOUT(
	MS_BTN4,      XXXXXXX,      XXXXXXX,      _______,      _______,      _______,                                  MS_WHLL,      MS_WHLD,      MS_WHLU,      MS_WHLR,      MS_BTN3,      MS_BTN5,
	...
	XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      MO_L5,        KC_0,         KC_1,         XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      MS_ACL2,      MS_ACL1,      MS_ACL0
  ),
