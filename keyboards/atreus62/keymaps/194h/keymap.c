...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L1] = LAYOUT(
	MS_BTN1,      MS_BTN3,      KC_PASTE,     KC_COPY,      SS_DQTS,      SS_QTS,                                   MS_LEFT,      MS_DOWN,      MS_UP,        MS_RGHT,      KC_FIND,      MS_BTN2,
	...
	KC_ESC,       KC_LCTL,      MO_L5,        KC_RALT,      O_L4,         O_L3,         KC_SPC,       KC_ENT,       O_L3,         O_L4,         KC_RALT,      KC_EQL,       KC_SCLN,      KC_COLN
  ),
  ...
  [L3] = LAYOUT(
	...
	XXXXXXX,      XXXXXXX,      SS_BRCS,      SS_POPC,      XXXXXXX,      XXXXXXX,      KC_UNDS,      SS_ENTV,      XXXXXXX,      XXXXXXX,      SS_CBRS,      KC_PLUS,      XXXXXXX,      XXXXXXX
  ),

  [L4] = LAYOUT(
	MS_BTN4,      MS_BTN3,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,                                  MS_WHLL,      MS_WHLD,      MS_WHLU,      MS_WHLR,      XXXXXXX,      MS_BTN5,
  ...
  [L5] = LAYOUT(
    ...
    XXXXXXX,      XXXXXXX,      KC_PSCR,      XXXXXXX,      KC_FIND,      KC_CALC,                                  KC_F1,        KC_F2,        KC_F3,        KC_F4,        KC_F5,        XXXXXXX,
    XXXXXXX,      QK_BOOT,      XXXXXXX,      XXXXXXX,      XXXXXXX,      KC_WFAV,                                  KC_F11,       KC_F12,       KC_LALT,      XXXXXXX,      KC_RCTL,      XXXXXXX,
