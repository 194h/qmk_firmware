...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L1] = LAYOUT(
	MS_BTN1,      MS_BTN3,      KC_CUT,       KC_COPY,      KC_PASTE,     MS_BTN3,                                  MS_LEFT,      MS_DOWN,      MS_UP,        MS_RGHT,      MS_BTN3,      MS_BTN2,
	...
	C_ESC,        KC_LCTL,      KC_LALT,      LM_G_L5,      O_L4,         O_L3,         KC_SPC,       KC_ENT,       O_L3,         O_L4,         LM_G_L5,      KC_RALT,      KC_SCLN,      KC_COLN
  ),
  ...
  [L3] = LAYOUT(
    ...
    _______,      KC_EQL,       KC_BSLS,      KC_PERC,      SS_CMNT,      KC_GRV,                                   NO_EN,        NO_EM,        KC_LT,        KC_GT,        KC_SLSH,      _______,
	XXXXXXX,      XXXXXXX,      SS_BRCS,      SS_POPC,      XXXXXXX,      XXXXXXX,      KC_UNDS,      SS_ENTV,      XXXXXXX,      XXXXXXX,      SS_CBRS,      XXXXXXX,      XXXXXXX,      XXXXXXX
  ),

  [L4] = LAYOUT(
	MS_BTN4,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,                                  MS_WHLL,      MS_WHLD,      MS_WHLU,      MS_WHLR,      XXXXXXX,      MS_BTN5,
	_______,      KC_0,         KC_9,         KC_8,         KC_7,         KC_6,                                     KC_HOME,      KC_PGDN,      KC_PGUP,      KC_END,       S_TAB,        KC_RGUI,
	_______,      KC_5,         KC_4,         KC_3,         KC_2,         KC_1,                                     KC_LEFT,      KC_DOWN,      KC_UP,        KC_RIGHT,     XXXXXXX,      XXXXXXX,
	KC_LSFT,      XXXXXXX,      KC_DEL,       KC_ESC,       XXXXXXX,      XXXXXXX,                                  KC_TAB,       XXXXXXX,      KC_COMM,      KC_DOT,       _______,      KC_RSFT,
	XXXXXXX,      KC_LCTL,      KC_RALT,      KC_LALT,      MO_L5,        KC_0,         KC_1,         XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      MS_ACL2,      MS_ACL1,      MS_ACL0
  ),
  ...
  [L5] = LAYOUT(
    ...
    XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      KC_WFAV,                                  XXXXXXX,      XXXXXXX,      KC_LALT,      XXXXXXX,      KC_RCTL,      XXXXXXX,
