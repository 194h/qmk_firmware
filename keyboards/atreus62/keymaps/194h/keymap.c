...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L1] = LAYOUT(
	...
	GUI_TAB,       KC_Q,         KC_W,         KC_E,         KC_R,         KC_T,                                     KC_Y,         KC_U,         KC_I,         KC_O,         KC_P,         OSM_LALT,
  ...
  [L4] = LAYOUT(
	XXXXXXX,       XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,                                  XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX
	KC_F1,         KC_F2,        KC_F3,        KC_F4,        KC_F5,        KC_F6,                                    KC_HOME,      KC_PGDN,      KC_PGUP,      KC_END,       XXXXXXX,      XXXXXXX,
	KC_F7,         KC_F8,        KC_F9,        KC_F10,       KC_F11,       KC_F12,                                   KC_LEFT,      KC_DOWN,      KC_UP,        KC_RIGHT,     _______,      XXXXXXX,
        KC_LSFT,       KC_1,         KC_2,         KC_3,         KC_4,         KC_4,                                     KC_6,         KC_7,         KC_8,         KC_9,         KC_0,         KC_RSFT,
        XXXXXXX,       XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      KC_BTN1,      KC_BTN2,      KC_BTN3,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX
  ),
